...
const LatestNotification = ({color, backgroundColor, border }) => {
  return (
    <div style={{borderColor: border, backgroundColor: backgroundColor}} className="w-full flex items-center py-[1px] sticky top-0 border-b z-50">
      ...
      <div style={{borderColor: border}} className="w-[82%] flex flex-nowrap overflow-hidden relative border-r">
        <ul className="flex items-center animate-infinite-scroll w-full justify-evenly">
          <li className="">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, provident culpa debitis id cum quibusdam distinctio eveniet mollitia deleniti libero.</li>
        </ul>
