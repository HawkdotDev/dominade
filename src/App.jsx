        ...
        <div className="flex font-hagrid font-bold w-full">
          ...
          >
            <div className="w-full h-[63.3%] pt-1 mt-2 mb-[5px]">
              <div className="h-[7%] w-[98%] flex justify-between mb-1">
                <h1 className="text-3xl font-bold">Editors Pick</h1>
                <button
                  onClick={() => {
                    alert("maybe some other time! boss is sleeping.");
                  }}
                  className="py-1 mb-1 px-2 rounded-sm bg-slate-700"
                >
                  see all
                </button>
              </div>
              <div className="h-[93%] w-[98%] flex flex-col justify-between">
                <div className="flex w-full h-[49%] justify-between">
                  <div className="w-[45%] bg-stone-800 flex">
                    <img
                  ...
                  <div className="w-[27%] relative">
                    ...
                    />
                    <div className="w-full h-full bg-black/50 absolute p-4 flex justify-between flex-col">
                      <div>
                        <div className="flex gap-2 items-center mb-1">
                        ...
                        <h1>Lorem ipsum dolor sit amet consectetur ?</h1>
                        <h2 className="text-sm text-gray-300/80 mt-2">
                          Lorem ipsum dolor sit, amet consectetur adipisicing
                          elit. Quos quod amet vero Lorem, ipsum dolor.
                        </h2>
                      </div>
                  ...
                  <div className="w-[25%] bg-neutral-700 p-6 flex items-center justify-center">
                    ads play here
                  </div>
                </div>
                <div className="w-full h-[48%] flex justify-between">
                  ...
                  <div className="w-[22%] h-full bg-purple-950">
            ...
            <div className="bg-green-700 w-full h-[34%] ">
              <h1 className="text-sm mt-3">Latest</h1>
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div className="pl-[14px]">
              <h1 className="px-2 py-[2px] mt-1">
                <h1 className="text-[#edad4c]">lendi story 1</h1>
                <h2 className="text-xs mt-[2px]">
              ...
              <div className="bg-blue-500 w-full h-[360px] mt-6 flex items-center justify-center">
                <h1>
                  ads play here
                </h1>
              </div>
